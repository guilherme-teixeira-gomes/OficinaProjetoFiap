...
exports.emailOrcamentoDisponivel = emailOrcamentoDisponivel;
exports.emailStatusAtualizado = emailStatusAtualizado;
...
// ─── Templates ───────────────────────────────────────────────────────────────
function emailOrcamentoDisponivel(clienteName, osId, budget, appUrl) {
...
function emailStatusAtualizado(clienteName, osId, status) {
    const statusLabels = {
